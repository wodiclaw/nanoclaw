...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // Apple Container only supports directory mounts, so .env shadowing is handled
    // inside the container entrypoint via mount --bind /dev/null (requires root).
    // The entrypoint.sh already does this when running as root (main containers).
